...
test("generic Apply entry routes visitors to confirmed sponsorship vacancies without mixed sorting", () => {
  assert.match(genericApplyPage, /redirect\("\/jobs\?sponsorship=confirmed&sort=newest"\)/);
});
