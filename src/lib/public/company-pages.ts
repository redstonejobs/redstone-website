...
export const companyPages: CompanyPageContent[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Support Channels", body: `Support is available through official Red Stone emails such as ${CONTACT.emails.support} and ${CONTACT.emails.complaints}.` },
    ],
  },
  {
    ...
    sections: [
      ...
      { title: "Reporting Concerns", body: `Concerns can be sent through complaints channels such as ${CONTACT.emails.complaints}.` },
    ],
  },
  {
    ...
    sections: [
      ...
      { title: "Report Suspicious Communication", body: `Report suspicious messages to ${CONTACT.emails.complaints} or through the complaints page.` },
    ],
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Report Suspicion", body: `Suspicious communication can be reported to ${CONTACT.emails.complaints}.` },
    ],
    callouts: [
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Jobs Enquiries", body: CONTACT.emails.jobs },
      { title: "Recruitment", body: CONTACT.emails.recruitment },
      { title: "Employers", body: CONTACT.emails.employers },
      { title: "Support", body: CONTACT.emails.support },
      { title: "Documents", body: CONTACT.emails.documents },
      { title: "Accounts", body: CONTACT.emails.accounts },
