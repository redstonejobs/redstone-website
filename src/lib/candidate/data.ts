...
const JOB_FIELDS = "id, title, slug, country, city, category, job_type, skill_level, salary_min, salary_max, currency, salary_period, vacancies, application_deadline, visa_sponsorship, accommodation, transport, meals, employer:employers(company_name)";
