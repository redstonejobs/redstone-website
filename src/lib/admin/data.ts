...
export async function getDashboardData() {
  ...
  return {
    ...
    needsAttention: [
      ...
      { label: "Employer Vacancy Requests", value: await countRows("employer_job_requests", { status: "submitted_for_review" }) },
      { label: "Employer Interview Requests", value: await countRows("employer_interview_requests", { status: "requested" }) },
      { label: "Employer Decisions Needing Action", value: await countRows("employer_application_decisions", { decision: "selected" }) },
