...
import { getCandidateApplications, getPublishedJobBySlug } from "@/lib/candidate/data";
      ...
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        {draftApplication && draftApplicationId ? (
          <form action={submitApplication.bind(null, draftApplicationId)} className="grid gap-6 rounded-md border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <Step title="Documents"><p>Upload documents from your application detail page after starting your draft.</p><Link href={`/candidate/applications/${draftApplicationId}`} className="font-bold text-[#B8860B]">Manage documents</Link></Step>
