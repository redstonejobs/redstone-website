...
function Footer() {
  const columns = [
    ...
    ["Legal", [["Privacy", "/privacy"], ["Terms", "/terms"], ["Payment Terms", "/payment-terms"], ["Refund & Cancellation", "/refund-cancellation"], ["Cookie Policy", "/cookies"], ["Accessibility", "/accessibility"]]],
  ] as const;
