...
function Footer() {
  const columns = [
    ...
    ["Legal", [["Privacy", "/privacy"], ["Account Deletion", "/account-deletion"], ["Terms", "/terms"], ["Payment Terms", "/payment-terms"], ["Refund & Cancellation", "/refund-cancellation"], ["Cookie Policy", "/cookies"], ["Accessibility", "/accessibility"]]],
  ] as const;
